...
namespace MySql.Data.MySqlClient
{
	internal class ISSchemaProvider : SchemaProvider
	{
		...
		{
			MySqlSchemaCollection expr_21 = this.Query("SCHEMATA", "", new string[]
			{
				"SCHEMA_NAME"
			}, restrictions);
			expr_21.Columns[1].Name = "database_name";
			expr_21.Name = "Databases";
			return expr_21;
		}
		public override MySqlSchemaCollection GetTables(string[] restrictions)
		{
			MySqlSchemaCollection expr_39 = this.Query("TABLES", "TABLE_TYPE != 'VIEW'", new string[]
			{
				"TABLE_CATALOG",
				"TABLE_SCHEMA",
				"TABLE_NAME",
		...
		{
			MySqlSchemaCollection expr_2D = this.Query("VIEWS", null, new string[]
			{
				"TABLE_CATALOG",
				"TABLE_SCHEMA",
				"TABLE_NAME"
		...
		{
			MySqlSchemaCollection expr_35 = this.Query("TRIGGERS", null, new string[]
			{
				"TRIGGER_CATALOG",
				"TRIGGER_SCHEMA",
				"EVENT_OBJECT_TABLE",
		...
		public override MySqlSchemaCollection GetProcedures(string[] restrictions)
		{
			...
			catch (MySqlException arg_1E_0)
			{
				if (arg_1E_0.Number != 1142)
				{
					throw;
				}
				this.connection.Settings.HasProcAccess = false;
			}
			MySqlSchemaCollection expr_76 = this.Query("ROUTINES", null, new string[]
			{
				"ROUTINE_CATALOG",
				"ROUTINE_SCHEMA",
				"ROUTINE_NAME",
		...
		{
			MySqlSchemaCollection expr_0A = new MySqlSchemaCollection("Procedure Parameters");
			expr_0A.AddColumn("SPECIFIC_CATALOG", typeof(string));
			expr_0A.AddColumn("SPECIFIC_SCHEMA", typeof(string));
			expr_0A.AddColumn("SPECIFIC_NAME", typeof(string));
			expr_0A.AddColumn("ORDINAL_POSITION", typeof(int));
			expr_0A.AddColumn("PARAMETER_MODE", typeof(string));
			expr_0A.AddColumn("PARAMETER_NAME", typeof(string));
			expr_0A.AddColumn("DATA_TYPE", typeof(string));
			expr_0A.AddColumn("CHARACTER_MAXIMUM_LENGTH", typeof(int));
			expr_0A.AddColumn("CHARACTER_OCTET_LENGTH", typeof(int));
			expr_0A.AddColumn("NUMERIC_PRECISION", typeof(byte));
			expr_0A.AddColumn("NUMERIC_SCALE", typeof(int));
			expr_0A.AddColumn("CHARACTER_SET_NAME", typeof(string));
			expr_0A.AddColumn("COLLATION_NAME", typeof(string));
			expr_0A.AddColumn("DTD_IDENTIFIER", typeof(string));
			expr_0A.AddColumn("ROUTINE_TYPE", typeof(string));
			return expr_0A;
		}

...
namespace MySql.Data.MySqlClient
{
	public sealed class MySqlTrace
	{
		...
		static MySqlTrace()
		{
			...
			IEnumerator enumerator = MySqlTrace.source.Listeners.GetEnumerator();
			try
			{
				while (enumerator.MoveNext())
				{
					if (((TraceListener)enumerator.Current).GetType().ToString().Contains("MySql.EMTrace.EMTraceListener"))
					{

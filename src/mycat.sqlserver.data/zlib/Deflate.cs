...
namespace zlib
{
	internal sealed class Deflate
	{
		...
		{
			byte[] arg_18_0 = this.pending_buf;
		...
		internal bool _tr_tally(int dist, int lc)
		{
			...
			else
			{
				this.matches++;
				dist--;
				short[] expr_A4_cp_0 = this.dyn_ltree;
				int expr_A4_cp_1 = ((int)Tree._length_code[lc] + 256 + 1) * 2;
				expr_A4_cp_0[expr_A4_cp_1] += 1;
				short[] expr_BD_cp_0 = this.dyn_dtree;
				int expr_BD_cp_1 = Tree.d_code(dist) * 2;

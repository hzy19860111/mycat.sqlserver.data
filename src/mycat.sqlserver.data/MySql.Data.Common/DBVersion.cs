...
namespace MySql.Data.Common
{
	internal struct DBVersion
	{
		...
		public static DBVersion Parse(string versionString)
		{
			...
			int num3 = Convert.ToInt32(versionString.Substring(num, num2 - num).Trim(), NumberFormatInfo.InvariantInfo);
			num = num2 + 1;
			...
			int num4 = Convert.ToInt32(versionString.Substring(num, num2 - num).Trim(), NumberFormatInfo.InvariantInfo);
			num = num2 + 1;
			int num5 = num;
			...
			int num6 = Convert.ToInt32(versionString.Substring(num, num5 - num).Trim(), NumberFormatInfo.InvariantInfo);
